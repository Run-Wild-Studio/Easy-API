...
class Logs extends Component
{
    ...
    {
        $this->logFile = Craft::$app->path->getLogPath() . '/easyapi.log';
    }
    ...
    public function log($method, $message, array $params = [], array $options = []): void
    {
        ...
        $message = Craft::t('easyapi', $message, $params);
        ...
        // Always prepend the api we're dealing with
        if (EasyApi::$apiName) {
            $message = EasyApi::$apiName . ': ' . $message;
        }
    ...
    {
        $loggingConfig = EasyApi::$plugin->service->getConfig('logging');
